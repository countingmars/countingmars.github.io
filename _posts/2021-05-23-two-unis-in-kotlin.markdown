...
그림: Any의 조상 Any?
![Any의 조상 Any?](https://miro.medium.com/max/129/0*4cfsgakE87aFmIQm) { width: 100px; }

그런데 이 관계는 스트링 타입에도 적용됩니다.

그림: String의 조상 String?
![String의 조상 String?](https://miro.medium.com/max/210/0*eK2eXZ2X_0-s7g_7) { width: 100px; }
...
![그림: 타노스의 핑거스냅(npe)을 막고 있는 Any 타입들](https://miro.medium.com/max/664/0*V-Yzh_-bB4FlmY45) { width: 200px; }
